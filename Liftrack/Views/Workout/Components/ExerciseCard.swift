    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 0) {
                ...
                // Add Set Button - Using onTapGesture for better performance
                HStack {
...
struct WorkoutSetRow: View {
    ...
    // Removed @Query to improve performance - previous data should be passed from parent if needed
    ...
    // Now returns nil - previous data loading removed for performance
